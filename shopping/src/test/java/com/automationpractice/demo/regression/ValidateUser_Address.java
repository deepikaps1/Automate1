...
public class ValidateUser_Address {
	...
	public void test1() {
        ...
        Myaccount_nuser Createuser = PageFactory.initElements(driver, Myaccount_nuser.class);
         ...
         Createuser.formfillup("trial"+ randomInt +"@abc.com","Tom","Jerry","trial"+ randomInt +"@abc.com","hgghuuj","12","9","2000","Tom","Jerry","abb","","Derby","20","23445","21","12341234","google");
    	 ...
    	 String expectedText = "address1 is required.";
