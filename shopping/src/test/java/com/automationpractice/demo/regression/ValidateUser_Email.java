...
public class ValidateUser_Email {
	...
	public void test1() {
        ...
        Myaccount_nuser Createuser = PageFactory.initElements(driver, Myaccount_nuser.class);
         ...
         Createuser.formfillup("trial"+ randomInt +"@abc.com","Tom","Jerry","","hello","12","9","2000","Tom","Jerry","abb","London Road","Derby","20","23445","21","12341234","google");
         WebDriverWait wait = new WebDriverWait( driver , 30);
         wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id=\"center_column\"]/div")));
         
         WebElement ErrMsg = driver.findElement(By.xpath("//*[@id=\"center_column\"]/div/ol/li[2]"));
