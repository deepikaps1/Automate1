...
public class ValidateUser_pswd {
	...
	public void test1() {
        ...
        Myaccount_nuser Createuser = PageFactory.initElements(driver, Myaccount_nuser.class);
         ...
         Createuser.formfillup("trial"+ randomInt +"@abc.com","Tom","Jerry","trial"+ randomInt +"@abc.com","","12","9","2000","Tom","Jerry","abb","London Road","Derby","20","23445","21","12341234","google");
    	 ...
    	 String expectedText = "passwd is required.";
