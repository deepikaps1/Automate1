...
public class ValidateUser_AddFname {
	...
	public void test1() {
        ...
        Myaccount_nuser Createuser = PageFactory.initElements(driver, Myaccount_nuser.class);
         ...
         Createuser.formfillup("trial"+ randomInt +"@abc.com","Tom","Jerry","trial"+ randomInt +"@abc.com","hgghuuj","12","9","2000","","Jerry","abb","London Road","Derby","20","23445","21","12341234","google");
